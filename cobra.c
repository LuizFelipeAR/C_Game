...
printf("Olá exploradores! Parece que voces estao presos numa tumba egipicia!\n");
...
printf("Mas nas outras caias nao tem nada nao =D\nBoa Sorte!\n\n");

printf("Jogador 1, Escolha um nome:\n");
printf("1) Alan\n2) Linus\n3) Steve\n4) Ada\n5) Neumann\n6) Zé Valim\n7) Rob Ieru\n\nDigite o número correspondente ao nome escolhido.");
